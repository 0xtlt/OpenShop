...
<CardGrid>
	...
	<Card title="Operate and troubleshoot" icon="wrench" href="/guides/operate-app/">
...
Tutorials teach a complete first success path. Guides solve one task. Reference
pages list exact APIs, options, defaults, constraints, and failure modes. Start
with [Architecture](/concepts/architecture/) for the runtime model, then use the
[Admin API](/reference/admin-api/) and [Public SDK](/reference/sdk/) references
when integrating OpenShop into application code.
